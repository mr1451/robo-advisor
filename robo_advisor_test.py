...
while True:
    SYMBOL = input("Please input a stock symbol, like AMZN:")
    if SYMBOL == "MIKE":
...
request_time = dt.datetime.now() # current date and time, see: https://github.com/prof-rossetti/georgetown-opim-243-201901/blob/master/notes/python/modules/datetime.md
